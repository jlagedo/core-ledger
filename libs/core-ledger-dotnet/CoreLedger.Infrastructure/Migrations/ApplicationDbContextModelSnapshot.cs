...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreLedger.Domain.Cadastros.Entities.ClassificacaoAnbima", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("classificacao_anbima", "cadastros");
                });
            ...
            modelBuilder.Entity("CoreLedger.Domain.Cadastros.Entities.FundoParametrosCota", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("CasasDecimaisCota")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(8)
                        .HasColumnName("casas_decimais_cota");

                    b.Property<int>("CasasDecimaisPl")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(2)
                        .HasColumnName("casas_decimais_pl");

                    b.Property<int>("CasasDecimaisQuantidade")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(6)
                        .HasColumnName("casas_decimais_quantidade");

                    b.Property<decimal>("CotaInicial")
                    ...
                    b.Property<DateOnly>("DataCotaInicial")
                        .HasColumnType("date")
                    ...
                    b.Property<TimeOnly>("HorarioCorte")
                        .HasColumnType("time")
                        .HasColumnName("horario_corte");

                    b.Property<bool>("PermiteCotaEstimada")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("permite_cota_estimada");

                    b.Property<string>("TipoCota")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.ToTable("fundo_parametros_cota", "cadastros");
                });

            modelBuilder.Entity("CoreLedger.Domain.Cadastros.Entities.FundoParametrosFIDC", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("CodigoRegistradora")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.Property<decimal?>("IndiceSubordinacaoAlvo")
                        .HasColumnType("decimal(5,4)")
                        .HasColumnName("indice_subordinacao_alvo");

                    b.Property<decimal?>("IndiceSubordinacaoMinimo")
                        .HasColumnType("decimal(5,4)")
                        .HasColumnName("indice_subordinacao_minimo");

                    b.Property<bool>("IntegracaoRegistradora")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("integracao_registradora");

                    b.Property<decimal?>("LimiteConcentracaoCedente")
                        .HasColumnType("decimal(5,4)")
                        .HasColumnName("limite_concentracao_cedente");

                    b.Property<decimal?>("LimiteConcentracaoSacado")
                        .HasColumnType("decimal(5,4)")
                        .HasColumnName("limite_concentracao_sacado");

                    b.Property<decimal?>("PercentualCoobrigacao")
                        .HasColumnType("decimal(5,4)")
                        .HasColumnName("percentual_coobrigacao");

                    b.Property<bool>("PossuiCoobrigacao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("possui_coobrigacao");

                    b.Property<int?>("PrazoMedioCarteira")
                        .HasColumnType("integer")
                        .HasColumnName("prazo_medio_carteira");

                    b.Property<decimal?>("ProvisaoDevedoresDuvidosos")
                        .HasColumnType("decimal(5,4)")
                        .HasColumnName("provisao_devedores_duvidosos");

                    b.Property<string>("RegistradoraRecebiveis")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("registradora_recebiveis");

                    b.Property<string>("TipoFidc")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                        .HasColumnName("tipo_fidc");

                    b.Property<string>("TiposRecebiveis")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("fundo_parametros_fidc", "cadastros");
                });
            ...
            modelBuilder.Entity("CoreLedger.Domain.Cadastros.Entities.FundoParametrosCota", b =>
                {
                    b.HasOne("CoreLedger.Domain.Cadastros.Entities.Fundo", "Fundo")
                        .WithOne("ParametrosCota")
                        .HasForeignKey("CoreLedger.Domain.Cadastros.Entities.FundoParametrosCota", "FundoId")
            ...
            modelBuilder.Entity("CoreLedger.Domain.Cadastros.Entities.FundoParametrosFIDC", b =>
                {
                    b.HasOne("CoreLedger.Domain.Cadastros.Entities.Fundo", "Fundo")
                        .WithOne("ParametrosFIDC")
                        .HasForeignKey("CoreLedger.Domain.Cadastros.Entities.FundoParametrosFIDC", "FundoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CoreLedger.Domain.Cadastros.Entities.Fundo", b =>
                {
                    ...
                    b.Navigation("ParametrosCota");

                    b.Navigation("ParametrosFIDC");
